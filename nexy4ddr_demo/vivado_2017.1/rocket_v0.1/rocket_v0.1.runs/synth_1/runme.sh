...
HD_PWD='/home/neutrino/vivado_work/rocket_v0.1/rocket_v0.1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log rocketTop.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source rocketTop.tcl
