...
HD_PWD='/home/neutrino/vivado_work/rocket_v0.1/rocket_v0.1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log rocketTop.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source rocketTop.tcl -notrace
